...
function saveApiKey() {
    ...
    if (newKey && newKey !== '••••••••••••••••') {
        ...
        alert('✅ API key saved successfully! Gemini AI features are now enabled.');
        keyInput.value = '••••••••••••••••';
        checkApiStatus();
    } else if (!newKey) {
...
function clearApiKey() {
    if (confirm('Are you sure you want to clear the API key? This will disable Gemini AI features.')) {
        ...
        checkApiStatus();
        alert('🗑️ API key cleared. Gemini AI features are now disabled.');
    }
}
...
function checkApiStatus() {
    ...
    if (userApiKey) {
        ...
        statusDiv.textContent = '✅ Gemini API key configured - Advanced features enabled';
    } else {
        statusDiv.className = 'api-status disconnected';
        statusDiv.textContent = '❌ Gemini API key not configured - Advanced features disabled';
    }
}
